...
redoc = [
    {
        ...
        'page': 'adminapispec',
        'spec': '_static/specs/adminapi.yaml',
        'embed': False,
        'opts': {
            'lazy-rendering': True,
            'hide-loading': True,
...
html_theme_options = {
	...
	'canonical_url' : 'https://docs.grommunio.com/',
...
htmlhelp_basename = 'grommuniodoc'
...
latex_documents = [
    (master_doc, 'grommunio.tex', 'grommunio Developer Documentation',
     'grommunio GmbH', 'manual', True),
]
...
man_pages = [
    (master_doc, 'grommunio', 'grommunio Developer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'grommunio', 'grommunio Developer Documentation',
     author, 'grommunioDevDocumentation', 'Developer documentation for grommunio.',
     'Miscellaneous'),
]
